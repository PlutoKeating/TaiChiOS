...
export function SystemMap() {
  ...
  return (
    <>
      <div className="system-map-visual" role="img" aria-label={locale === 'zh' ? 'TaiChiOS 太极标志' : 'TaiChiOS taiji mark'}>
      ...
      <ol className="system-map-layers" aria-label={locale === 'zh' ? 'TaiChiOS 六层系统架构' : 'TaiChiOS six-layer system architecture'}>
        {layers.map(([label, name], index) => (
          <li className="system-layer" key={label}>
