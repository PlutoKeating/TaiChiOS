...
> [!IMPORTANT]
> TaiChiOS provides its latest bootable, installable, runnable [`v0.1.0-mvp.5` image](https://github.com/PlutoKeating/TaiChiOS/releases/tag/v0.1.0-mvp.5). The same release payload passes QEMU BIOS/UEFI Live-shell, whole-disk installation, installed-login-page, disk-first-boot, and independent-recovery checks. This is not a stable release; its factory credentials are for development acceptance only.
