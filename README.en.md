...
> [!IMPORTANT]
> TaiChiOS provides its first bootable, installable, runnable [`v0.1.0-mvp.2` image](https://github.com/PlutoKeating/TaiChiOS/releases/tag/v0.1.0-mvp.2). The same release payload passes QEMU BIOS/UEFI live boot, whole-disk installation, disk-first-boot, and recovery checks. This is not a stable release; its factory credentials are for development acceptance only.
